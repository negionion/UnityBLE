...
public class BTsocket : MonoBehaviour {
	...
	public static void writeCharacteristic(string sendStr)
	{
		if (!BTStatus)
			return;
		BTLog = "writeStart!\n";
		...
		BluetoothLEHardwareInterface.WriteCharacteristic(
			linkData.address, BluetoothData.fullUUID(linkData.service), BluetoothData.fullUUID(linkData.wCharacteristic),
			sendData, sendData.Length,
			false, (deviceAddress) => {BTLog = "send : " + sendData + "\n" + deviceAddress; });
	}
